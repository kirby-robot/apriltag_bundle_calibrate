...
CALIB_BOARD_PARAMS = dict(
    board_size = [0.645, 0.8],        # 60cm*80cm
...
# XY
CALIB_BOARD_PARAMS['t16h5']['tag_ids'] = list(range(len(single_board_centers)))
CALIB_BOARD_PARAMS['t16h5']['centers'] = np.stack([
    single_board_centers[:, 1],
    single_board_centers[:, 0],
    np.zeros([single_board_centers.shape[0]], dtype=np.float32)
], axis=-1)
CALIB_BOARD_PARAMS['t16h5']['corners'] = np.stack([
...
# YZ
CALIB_BOARD_PARAMS['t25h7']['tag_ids'] = list(range(len(single_board_centers)))
CALIB_BOARD_PARAMS['t25h7']['centers'] = np.stack([
    np.zeros([single_board_centers.shape[0]], dtype=np.float32),
    CALIB_BOARD_PARAMS['board_size'][1] - single_board_centers[:, 1],
    CALIB_BOARD_PARAMS['board_size'][0] - single_board_centers[:, 0],
], axis=-1)
CALIB_BOARD_PARAMS['t25h7']['corners'] = np.stack([
    np.zeros([single_board_corners.shape[0], 4], dtype=np.float32),
...
# ZX
CALIB_BOARD_PARAMS['t36h11']['tag_ids'] = list(range(len(single_board_centers)))
CALIB_BOARD_PARAMS['t36h11']['centers'] = np.stack([
    CALIB_BOARD_PARAMS['board_size'][0] - single_board_centers[:, 0],
    np.zeros([single_board_centers.shape[0]], dtype=np.float32),
    CALIB_BOARD_PARAMS['board_size'][1] - single_board_centers[:, 1],
], axis=-1)
CALIB_BOARD_PARAMS['t36h11']['corners'] = np.stack([
    CALIB_BOARD_PARAMS['board_size'][0] - single_board_corners[:, :, 0],
    np.zeros([single_board_corners.shape[0], 4], dtype=np.float32),
    CALIB_BOARD_PARAMS['board_size'][1] - single_board_corners[:, :, 1],
], axis=-1)
